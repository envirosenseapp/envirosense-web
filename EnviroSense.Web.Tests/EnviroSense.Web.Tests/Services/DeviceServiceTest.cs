...
public class DeviceServiceTest: IDisposable
{
    ...
    {
        _accountService.Setup(e => e.GetAccountIdFromSession()).
            Returns("01a4260a-ef07-47ef-97f8-1ca333fd930a");

        _deviceRepository.Setup(e => e.ListAsync(It.IsAny<Guid>())).
    ...
    {
        _accountService.Setup(e => e.GetAccountIdFromSession()).
            Throws(new Exception("Session is available"));
